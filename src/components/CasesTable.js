                    ...
                    <TableRow key={el.trackedEntityInstance}>
                        ...
                        <TableCell dataTest="details-first-name">
                            <a href={`${baseUrl}/dhis-web-tracker-capture/index.html#/dashboard?tei=${el.trackedEntityInstance}&program=${el.program}&ou=iVgNipWEgvE`} target="_blank">
                                <Button
                                    ...
                                    icon={<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="external-link-alt" className="svg-inline--fa fa-external-link-alt fa-w-16" role="img" viewBox="0 0 512 512">
                        ...
                        {viewContext !== "Contact cases" && (
                            <TableCell dataTest="deta-first-name">
                                <Button
                                    dataTest="dhis2-uicore-button"
                                    icon={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-friends" className="svg-inline--fa fa-user-friends fa-w-20" role="img" viewBox="0 0 640 512">
