                        ...
                        <TableCell dataTest="details-first-name">
                            <a href={`${baseUrl}/dhis-web-tracker-capture/index.html#/dashboard?tei=${el.trackedEntityInstance}&program=${el.program}&ou=iVgNipWEgvE`} target="_blank">
                                <Button
                                    ...
                                    icon={<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="external-link-alt" class="svg-inline--fa fa-external-link-alt fa-w-16" role="img" viewBox="0 0 512 512">
